...
export function OKRsPage() {
  ...
  const canManageStructure =
    canAccess("okrs:manage") || canAccess("okrs:manage:department");
  ...
  const canCreateWithDependencies =
    canManageStructure &&
    !!data &&
    data.filters.objectives.length > 0 &&
    data.filters.responsibles.length > 0;

  const canEditOkr = (okr: OkrItem) => canManageStructure;
  const canDeleteOkr = (okr: OkrItem) => canDeleteStructure;
